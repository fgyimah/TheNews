...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        //make http call
        Call<ResponseModel> call = apiService.getLatestNewsByCat("us","health","popularity",100,getResources().getString(R.string.apiKey));
        call.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(@NonNull Call<ResponseModel> call, @NonNull Throwable t) {
                ...
                progressBar.setVisibility(View.GONE);
                Toast.makeText(getActivity(),"Please check your internet conncection",Toast.LENGTH_SHORT)
                        .show();
            }
        });
